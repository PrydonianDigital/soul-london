;(function($){var $body=$('body'),$pageslide=$('#pageslide');var _sliding=false,_lastCaller;function _load(url,useIframe){if(url.indexOf("#")===0){return;}else{if(useIframe){var iframe=$("<iframe />").attr({src:url,frameborder:0,hspace:0}).css({width:"100%",height:"100%"});$pageslide.html(iframe);}else{$pageslide.load(url);}
