...
class MyCustomWidget extends WP_Widget {
	function MyCustomWidget() {
		$widget_ops = array('classname' => 'class_name', 'description' => __('Widget Description.', 'language'));
		$this->WP_Widget('class_name', $ttrust_theme_name.' '.__('Widget Name', 'language'), $widget_ops);
	}
}
...
register_sidebar(array(
	'name' => 'Slide Menu Sidebar',
	'id' => 'sidebar_slidenav',
	'description' => __('This is the widget area for the slide out menu.', 'themetrust'),
	'before_widget' => '<div id="%1$s" class="%2$s sidebarBox widgetBox">',
	'after_widget' => '</div>',
	'before_title' => '<span class="widgetTitle">',
	'after_title' => '</span>'
...
class TTrust_Recent_Posts extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct('ttrust_recent_posts', $ttrust_theme_name.' '.__('Recent Posts', 'themetrust'), $widget_ops);
	}
...
class TTrust_Flickr extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct('ttrust_flickr', $ttrust_theme_name.' '.__('Flickr', 'themetrust'), $widget_ops);
...
class TTrust_Testimonials extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct('ttrust_testimonials', $ttrust_theme_name.' '.__('Testimonials', 'themetrust'), $widget_ops);
	}
